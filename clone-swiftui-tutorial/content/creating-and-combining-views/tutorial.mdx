...
## !question When creating a custom SwiftUI view, where do you declare the view’s layout?

1. In the `body` property of the view’s structure.
2. In the `@main` attribute of the app’s entry point.
3. In the `WindowGroup` initializer of the app’s entry point.

## !question What does the `foregroundColor(.green)` modifier do?

1. It changes the text’s color to green.
2. It changes the text’s color to black.
3. It removes the text’s color.
